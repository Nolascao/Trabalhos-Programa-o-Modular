...
public class Livros {
    ...
    public Livros(String nome, int codigo){ 
        this.nome = nome;
        this.codigo = codigo; 
        this.clienteEmPosse = null;
    }
    ...
    */
    ...
    public void emprestimoMaisRecente(){ 
        System.out.println("O empréstimo mais recente desse livro foi feito pelo Cliente: "+ this.clienteEmPosse.getNome()+", no dia "+ this.getDataEmprestimo().toString()+ "e deve ser devolvido no dia "+this.getDataDevolucao().toString());
    } 

    @Override 
    public String toString(){  
       return "Nome: " + this.nome + " / Código: " + Integer.toString(this.codigo);
    }
